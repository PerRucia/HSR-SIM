...
class Feixiao(Character):
    ...
    def useSkl(self, enemyID=-1):
        ...
        fuaTypes = ["FUA", "ULT", "DUKEFUA"] if self.eidolon == 6 else ["FUA","DUKEFUA"]
    ...
    def useUlt(self, enemyID=-1):
        ...
        for i in range(6):
            tl.append(Turn(self.name, self.role, self.getTargetID(enemyID), "ST", ["ULT", "FUA", "DUKEULT"], [self.element], [baseHitMul * dmgMul[i], 0], [10, 0], 0, self.scaling, 0, "FeixiaoUlt"))
        tl.append(Turn(self.name, self.role, self.getTargetID(enemyID), "ST", ["ULT", "FUA", "DUKEULT"], [self.element], [finalHitMul * dmgMul[6], 0], [0, 0], 0, self.scaling, 0, "FeixiaoUltFinal"))
        return bl, dbl, al, dl, tl
