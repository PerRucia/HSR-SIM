...
class Fuxuan(Character):
    ...
    def equip(self):
        ...
        bl.append(Buff("FXTraceERS", "ERS%", 0.1, self.role, ["ALL"], 1, 1, "SELF", "PERM"))
        bl.append(Buff("FXTraceCR", "CR%", 0.187, self.role, ["ALL"], 1, 1, "SELF", "PERM"))
        bl.append(Buff("FXTraceHP", "HP%", 0.18, self.role, ["ALL"], 1, 1, "SELF", "PERM"))
        return bl, dbl, al, dl
    ...
    def useSkl(self, enemyID=-1):
        ...
        bl.append(Buff("FuxuanCR", "CR%", 0.12, "ALL", ["ALL"], 3, 1, self.role, "END"))
        return bl, dbl, al, dl, tl
