...
class Sparkle(Character):
    ...
    def __init__(self, pos: int, role: Role, defaultTarget: int = -1, lc = None, r1 = None, r2 = None, pl = None, subs = None, eidolon = 0, targetRole = Role.DPS, quaAllies = 0, rotation = None, targetPrio = Priority.DEFAULT) -> None:
    ...
    def useBsc(self, enemyID=-1):
        ...
        tl.append(Turn(self.name, self.role, self.bestEnemy(enemyID), Targeting.SINGLE, [AtkType.BSC], [self.element], [e3Mul, 0], [10, 0], 30, self.scaling, 1, "SparkleBasic"))
    ...
    def useSkl(self, enemyID=-1):
        ...
        tl.append(Turn(self.name, self.role, -1, Targeting.NA, [AtkType.SKL], [self.element], [0, 0], [0, 0], 30, self.scaling, -1, "SparkleSkill"))
    ...
    def useUlt(self, enemyID=-1):
        ...
        tl.append(Turn(self.name, self.role, -1, Targeting.NA, [AtkType.ULT], [self.element], [0, 0], [0, 0], 5, self.scaling, e4SP, "SparkleUlt"))
    ...
    def handleSpecialStart(self, specialRes: Special):
        ...
        if self.startSP:
            self.startSP = False
            tl.append(Turn(self.name, self.role, -1, Targeting.NA, [AtkType.SPECIAL], [self.element], [0, 0], [0, 0], 0, self.scaling, 3, "SparkleTechSP"))
