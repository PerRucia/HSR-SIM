...
class Nightglow(Lightcone):
    ...
    def equip(self):
        ...
        buffList.append(Buff("NightglowERR", "ERR%", err, self.wearerRole, ["ALL"], 1, 1, "SELF", "PERM"))
    ...
    def useUlt(self, enemyID):
        ...
        buffList.append(Buff("NightglowATK", "ATK%", atk, self.wearerRole, ["ALL"], 1, 1, "SELF", "END"))
        buffList.append(Buff("NightglowDMG", "DMG%", dmg, self.wearerRole, ["ALL"], 1, 1, "SELF", "END"))
        return buffList, debuffList, advList, delayList    
