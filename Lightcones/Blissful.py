...
class Blissful(Lightcone):
    ...
    def equip(self):
        ...
        buffList.append(Buff("BlissfulCR", Pwr.CR_PERCENT, crBuff, self.wearerRole, ["ALL"], 1, 1, Role.SELF, TickDown.PERM))
    ...
    def useFua(self, enemyID):
        ...
        dbl.append(Debuff(f"BlissfulTame{self.wearerRole.name}", self.wearerRole, Pwr.CD_PERCENT, cdBuff, self.defaultTarget, ["ALL"], 1000, 2, False, [0, 0], False))
        return bl, dbl, al, dl
