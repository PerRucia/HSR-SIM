...
class Cruising(Lightcone):
    ...
    def equip(self):
        ...
        buffList.append(Buff("CruisingCR", Pwr.CR_PERCENT, crBuff, self.wearerRole, ["ALL"], 1, 1, Role.SELF, TickDown.PERM))
        atkBuff = (self.level * 0.05 + 0.15) * self.uptime
        buffList.append(Buff("CruisingATK", Pwr.ATK_PERCENT, atkBuff, self.wearerRole, ["ALL"], 1, 1, Role.SELF, TickDown.PERM))
